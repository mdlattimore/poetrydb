...
system('printf "\e[8;35;90;t"')  # sets window size on mac os terminal ONLY


def banner_text(text: str = " ") -> None:  # function performs an action, does NOT return a result
    ...
    centered_text = text.center(width[0] - 4, '*')
...
clear()
print()
banner_text("   Welcome to the Python Poetry Database   ")
